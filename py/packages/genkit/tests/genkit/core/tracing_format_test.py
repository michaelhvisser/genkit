...
def test_init_provider_does_not_rewrite_log_format() -> None:
    ...
    with (
        patch('genkit._core._telemetry.otel.trace_api.get_tracer_provider', return_value=None),
        patch('genkit._core._telemetry.otel.trace_api.set_tracer_provider'),
        patch('genkit._core._telemetry.otel.LoggingInstrumentor', return_value=instrumentor),
    ):
        init_provider()
